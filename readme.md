...
- Fill/populate Merge Fields from a Microsoft Word file (.docx) from a given dataframe (an example is provided in the [business-card-generator.py](business-card-generator.py) code).
